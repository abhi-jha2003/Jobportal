    ...
    <div className='max-w-7xl mx-auto my-10'>
      ...
      <div className='flex items-center gap-2 mt-4'>
        ...
        <Button onClick={isApplied ? null:applyJobHandler} disabled={isApplied}
         className={`rounded-lg text-white  ${isApplied ? 'bg-gray-600 cursor-not-allowed hover:bg-gray-400':'bg-[#7209b7] hover:bg-[#5f32ad]'} `}  >{isApplied ? `Already Applied`:`Apply Now`}</Button>
        </div>
